...
DESTINATIONS: list[DestinationProfile] = [
    ...
    DestinationProfile(
        ...
        country="Россия",
        currency="RUB",
        best_season="июнь–сентябрь для тёплых прогулок и выездов; декабрь–февраль — для зимней атмосферы",
        vibe="старинный сибирский город с деревянной архитектурой, университетами и спокойным ритмом",
        quick_facts=[
            "один из старейших городов Сибири (основан в 1604 году)",
            "деревянное зодчество — главная фишка: резные наличники и исторические кварталы",
            "университетский город: два крупных вуза задают моложёную атмосферу",
        ],
        hotel_areas=[
            "центр / Советский район — для первого знакомства, рядом главные улицы и кафе",
            "Кировский район — тихий, с хорошей инфраструктурой и близостью к набережной Томи",
            "апартаменты около ж/д вокзала — удобно при поездке на автобусе/поезде",
        ],
        transport_notes=[
            "из Иркутска: автобус ~10-12 часов (от ~3 000 ₽), поездка на машине ~1000 км",
            "внутри города удобно ходить пешком + такси для дальних точек",
            "на 3 дня не стоит ставить больше 2 районов в день",
        ],
        alternatives=[
            "Красноярск — более крупный город с разнообразием, но меньше исторического шарма",
            "Новосибирск — мегаполис Сибири, если нужны масштабные музеи и шопинг",
            "Иркутск — если ещё не были: деревянная архитектура и Байкал рядом",
        ],
        place_groups={
            "default": [
                "исторический центр: Воскресенская гора, Белое озеро, деревянные особняки",
                "прогулка по набережной Томи и парки",
                "университетский квартал и современная городская среда",
            ],
            "еда": [
                "кафе и рестораны в центре — сибирская кухня и пельмени",
                "рынок и локальные гастро-точки",
            ],
            "история": [
                "краеведческий музей и деревянные памятники",
                "маршрут по купеческому Томску и старым улицам",
            ],
            "природа": [
                "парк и выезды к природным точкам (синий яр, тайга)",
            ],
        },
        transport_range=(3000, 10000),
        lodging_per_night=(1500, 3500),
        food_per_day=(1000, 2200),
        local_per_day=(250, 600),
        activity_per_trip=(800, 2500),
        aliases=("томь",),
    ),
]
